...
#include "luci_micro/Import/MicroGraphBuilderRegistry.h"
#include "luci_micro/Import/Nodes/CircleConstProxy.h"
...
MicroGraphBuilderRegistry::MicroGraphBuilderRegistry() : _builders(circle::BuiltinOperator_MAX + 1)
{
...
CircleNode *MicroGraphBuilderRegistry::create_const(GraphBuilderContext *context,
                                                    int32_t tensor_index) const
{
  return create_circleconst_proxy(context, tensor_index);
}
