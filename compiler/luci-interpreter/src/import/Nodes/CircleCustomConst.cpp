...
#include "Nodes/CircleCustomConst.h"
...
// helper struct which describes data loaded to custom_options of CircleCustomConst node
...
CircleNode *CircleCustomConstTensorBuilder::build(TensorIndex tensor_index,
                                                  GraphBuilderContext *context) const
{
  ...
  // create CircleCustomConst
  auto custom_node = graph->nodes()->create<CircleCustom>(0, 1);
  {
    custom_node->custom_code("CircleCustomConst");
