...
#ifndef __LUCI_IMPORT_SPECIAL_NODE_BUILDER_H__
#define __LUCI_IMPORT_SPECIAL_NODE_BUILDER_H__
...
enum class NodeBuilderType
{
  ...
  _NUMBER_OF_ITEMS // Count of different types
};
...
#endif // __LUCI_IMPORT_SPECIAL_NODE_BUILDER_H__
