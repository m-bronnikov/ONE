...
#include "micro/TestMemoryManager.h"

namespace micro
{

void TestMemoryManager::allocate_memory(micro::Tensor &tensor)
{
...
void TestMemoryManager::release_memory(micro::Tensor &tensor) { tensor.set_data_buffer(nullptr); }
