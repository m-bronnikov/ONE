...
#ifndef __MICRO_IMPORT_OP_CIRCLE_MATRIX_SET_DIAG_H__
#define __MICRO_IMPORT_OP_CIRCLE_MATRIX_SET_DIAG_H__
...
#endif // __MICRO_IMPORT_OP_CIRCLE_MATRIX_SET_DIAG_H__
