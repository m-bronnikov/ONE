...
#ifndef __MICRO_IMPORT_OP_CIRCLE_RESIZE_BILINEAR_H__
#define __MICRO_IMPORT_OP_CIRCLE_RESIZE_BILINEAR_H__
...
#endif // __MICRO_IMPORT_OP_CIRCLE_RESIZE_BILINEAR_H__
