...
#ifndef __MICRO_IMPORT_OP_CIRCLE_SQUAREDDIFFERENCE_H__
#define __MICRO_IMPORT_OP_CIRCLE_SQUAREDDIFFERENCE_H__
...
#endif // __MICRO_IMPORT_OP_CIRCLE_SQUAREDDIFFERENCE_H__
