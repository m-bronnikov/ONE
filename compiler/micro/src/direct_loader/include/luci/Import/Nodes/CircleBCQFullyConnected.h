...
#ifndef __MICRO_IMPORT_OP_CIRCLE_BCQFULLYCONNECTED_H__
#define __MICRO_IMPORT_OP_CIRCLE_BCQFULLYCONNECTED_H__
...
#endif // __MICRO_IMPORT_OP_CIRCLE_BCQFULLYCONNECTED_H__
