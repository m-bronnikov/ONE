...
#ifndef __MICRO_IMPORT_OP_CIRCLE_REVERSE_SEQUENCE_H__
#define __MICRO_IMPORT_OP_CIRCLE_REVERSE_SEQUENCE_H__
...
#endif // __MICRO_IMPORT_OP_CIRCLE_REVERSE_SEQUENCE_H__
