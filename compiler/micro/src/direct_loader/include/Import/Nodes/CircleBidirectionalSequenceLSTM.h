...
#ifndef __MICRO_IMPORT_OP_CIRCLE_BIDIRECTIONALSEQUENCE_LSTM_H__
#define __MICRO_IMPORT_OP_CIRCLE_BIDIRECTIONALSEQUENCE_LSTM_H__
...
#endif // __MICRO_IMPORT_OP_CIRCLE_BIDIRECTIONALSEQUENCE_LSTM_H__
