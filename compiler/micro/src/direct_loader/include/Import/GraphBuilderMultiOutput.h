...
#ifndef __MICRO_IMPORT_GRAPH_BUILDER_MULTI_OUTPUT_H__
#define __MICRO_IMPORT_GRAPH_BUILDER_MULTI_OUTPUT_H__
...
#endif // __MICRO_IMPORT_GRAPH_BUILDER_MULTI_OUTPUT_H__
