...
#ifndef __MICRO_IMPORT_GRAPHREADER_H__
#define __MICRO_IMPORT_GRAPHREADER_H__
...
Activation luci_actfunc(const circle::ActivationFunctionType type);
...
std::unique_ptr<luci::CircleQuantParam>
...
void copy_tensor_attributes(const circle::TensorT &tensor, luci::CircleNode *node);
...
#endif // __MICRO_IMPORT_GRAPHREADER_H__
