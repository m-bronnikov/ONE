...
#ifndef __MICRO_IMPORT_GRAPH_BUILDER_CONTEXT_H__
#define __MICRO_IMPORT_GRAPH_BUILDER_CONTEXT_H__
...
public:
  ...
  luci::CircleNode *node(TensorIndex idx) const;

private:
  using MapIndexNode_t = std::map<TensorIndex, luci::CircleNode *>;
...
#endif // __MICRO_IMPORT_GRAPH_BUILDER_CONTEXT_H__
