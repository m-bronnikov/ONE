...
void InstanceNorm::configure()
{
  ...
  MICRO_CHECK(gamma()->element_type() == input()->element_type());
  MICRO_CHECK(gamma()->shape().num_dims() == 1);
  MICRO_CHECK(gamma()->shape().dim(0) == input()->shape().dim(3) || gamma()->shape().dim(0) == 1);
  MICRO_CHECK(beta()->element_type() == input()->element_type());
  MICRO_CHECK(beta()->shape().num_dims() == 1);
  MICRO_CHECK(beta()->shape().dim(0) == input()->shape().dim(3) || beta()->shape().dim(0) == 1);
