...
macro(add_pal_to_target TGT)
    ...
    add_library(micro_linux_pal STATIC ${PAL_SOURCES})
    set_target_properties(micro_linux_pal PROPERTIES POSITION_INDEPENDENT_CODE ON)
    target_include_directories(micro_linux_pal SYSTEM PRIVATE "${TensorFlowSource_DIR}")

    target_link_libraries(${TGT} PRIVATE Threads::Threads micro_linux_pal)
endmacro()
